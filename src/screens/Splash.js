...
const Splash=()=>{
	...
	const load_prestations=async ()=>{
        const res=await fetch("https://ongadesco.org/admin/wp-json/wp/v2/prestations?per_page=100");
        const data=await res.json();
        dispatch(setPrestations(data))
    }
